...
const HeroSection = () => {
  ...
  const heroImage =
    "https://images.unsplash.com/photo-1550104289-6557645f754d?q=80&w=2835&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D";
  const imageUrls = [BowlOne, BowlTwo, BowlFour, BowlSix];
  return (
